                ...
                <div className="order-2 lg:order-1 space-y-8 animate-in fade-in slide-in-from-left duration-700">
                    ...
                    <div className="space-y-6">
                        <p className="text-muted-foreground leading-relaxed">
                            Selama masa kuliah, saya aktif mengikuti berbagai proyek
                            pengembangan web dan mobile sebagai bagian dari tugas akhir,
                            kerja praktik, maupun pembelajaran mandiri. Pengalaman ini
                            membantu saya memahami dasar-dasar teknologi frontend dan
                            backend, serta pentingnya menulis kode yang terstruktur dan
                            mudah dipahami.
                        </p>
                        <p className="text-muted-foreground leading-relaxed">
